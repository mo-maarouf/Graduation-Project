...
export const BanReasonColors: Record<BanReason, { light: string; dark: string }> = {
  ...
  [BanReason.FALSE_ADVERTISING]: { light: 'text-blue-700 bg-blue-50', dark: 'dark:text-blue-300 dark:bg-blue-900/20' },
  ...
  [BanReason.OTHER]: { light: 'text-gray-700 bg-gray-50', dark: 'dark:text-gray-300 dark:bg-gray-800' }
}
