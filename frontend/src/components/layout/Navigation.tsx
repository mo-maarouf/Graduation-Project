...
export default function Navigation() {
  ...
  return (
    <nav suppressHydrationWarning className="fixed top-0 w-full z-50 glass-theme border-b border-[#c8d8f8] dark:border-[#1a3566]">
                ...
                <div className="relative">
                  ...
                  {isUserMenuOpen && (
                    <div className="absolute right-0 top-full mt-1 w-56 sm:w-64 surface-card border border-theme rounded-xl shadow-xl py-2 z-50">
                      <div className="px-4 py-3 border-b border-[#c8d8f8] dark:border-[#1a3566] overflow-hidden">
                      ...
                      <div className="border-t border-[#c8d8f8] dark:border-[#1a3566] pt-2">
                        <button
                          onClick={() => {
                            logout();
