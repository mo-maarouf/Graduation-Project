  ...
  return (
    ...
    ">
      ...
      <div className="
        ...
        bg-emerald-200/30 dark:bg-emerald-500/10
        rounded-full
        blur-3xl
      " />
      ...
      <div className="
        ...
        w-40 h-0.5
        bg-gradient-to-r
        from-blue-400/50 via-indigo-400/50 to-emerald-400/50
        dark:from-blue-600/30 dark:via-indigo-600/30 dark:to-emerald-600/30
  ...
  return (
    <section 
      className="
        ...
        overflow-hidden
      "
      aria-label="Live community impact map"
    >
      {/* ========================================
      ...
      <div className="
        absolute inset-0
        bg-gradient-to-b
        from-transparent via-blue-50/30 to-transparent
