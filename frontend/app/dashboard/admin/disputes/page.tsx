    ...
    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8">
     <div className="space-y-2">
      <div className="flex items-center gap-3">
       ...
       <span className="text-[10px] font-black text-primary-light capitalize tracking-[0.2em] bg-primary-light/10 px-3 py-1 rounded-xl border border-primary-light/10">Arbitration Center</span>
      </div>
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="px-4 py-2 surface-card hover:bg-primary-light hover:text-white border border-theme rounded-xl transition-all shadow-sm active:scale-95 flex items-center gap-2"
        >
          <RefreshCw className="w-4 h-4" />
          <span className="text-[10px] font-black capitalize tracking-normal">Reset Filters</span>
        </button>
      </div>
      <p className="text-sm text-theme-muted font-medium max-w-lg">
     ...
     <div className="flex items-center gap-4">
      <div className="px-6 py-4 surface-card rounded-[2rem] border border-theme shadow-sm flex flex-col items-center min-w-[120px] border-b-4 border-b-primary-light">
       <span className="text-[8px] font-black text-theme-muted capitalize tracking-normal mb-1">Open Cases</span>
       <span className="text-2xl font-black text-theme-primary">{stats.pending + stats.underReview}</span>
      </div>
     </div>
    </div>
