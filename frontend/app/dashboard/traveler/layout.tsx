...
export default function TravelerDashboardLayout({
 ...
 // Role guard
 useEffect(() => {
 if (!isLoading && (!user || user.role !== 'TRAVELER')) {
 ...
 ======================================== */}
  ...
  <div>
  <h2 className="font-bold text-xs capitalize tracking-normal text-theme-primary">Traveler</h2>
  <p className="text-[9px] font-bold text-theme-muted capitalize tracking-tighter">Command Center</p>
  </div>
  </div>
  <button
  onClick={() => setIsSidebarOpen(false)}
