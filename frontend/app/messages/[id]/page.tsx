    ...
    <div className={`flex gap-3 ${message.isOwn ? 'flex-row-reverse' : ''}`}>
      ...
      <div className={`flex-1 max-w-[70%] ${message.isOwn ? 'text-right' : ''}`}>
        ...
        <div className="relative group">
          {shouldBlur && (
            <div className="absolute inset-0 backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 rounded-2xl flex items-center justify-center z-10">
              <button
        ...
        <div className={`flex items-center gap-1 mt-1 text-xs text-gray-500 dark:text-gray-400 ${message.isOwn ? 'justify-end' : ''}`}>
          <span>{time}</span>
        ...
        {!message.isOwn && !message.isFlagged && (
          <div className="relative inline-block">
            ...
            {showFlagMenu && (
              <div className="absolute left-0 mt-1 w-48 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-xl z-10 p-1">
                <button
                  onClick={handleFlag}
...
export default function MessageThreadPage() {
  ...
  return (
    <PageLayout>
      <div className="pt-14 sm:pt-16 h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] bg-gray-50 dark:bg-gray-950 overflow-hidden">
        <div className="h-full flex flex-col">
          ...
          <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg lg:hidden"
              >
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            {conversation.booking && (
              <div className={`
                w-80 border-l border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 p-4 overflow-y-auto
              ...
              `}>
                <div className="space-y-4">
                  ...
                  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4">
                    <div className="relative w-full h-32 rounded-lg bg-gray-200 dark:bg-gray-800 mb-3">
