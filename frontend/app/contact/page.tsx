...
const ContactMethodCard = ({ method }: { method: typeof CONTACT_METHODS[0] }) => {
  ...
  return (
    <a
      href={method.href}
      className="group block p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
    >
      ...
      <p className="text-blue-600 dark:text-blue-400 font-medium text-sm group-hover:underline">
        {method.action}
      </p>
    </a>
  )
...
export default function ContactPage() {
  return (
    <PageLayout>
      <div className="pt-14 sm:pt-16 bg-white dark:bg-gray-950">
        ...
        <section className=" bg-white dark:bg-gray-950 py-24 sm:py-20.5">
                    ...
                    {OFFICES.map((office, index) => (
                      <div key={index} className="border-b border-gray-200 dark:border-gray-800 last:border-0 pb-4 last:pb-0">
                        ...
                        <div className="mt-2 space-y-1 text-sm">
                          <a href={`tel:${office.phone}`} className="text-blue-600 dark:text-blue-400 hover:underline block">
                            {office.phone}
                          </a>
                          <a href={`mailto:${office.email}`} className="text-blue-600 dark:text-blue-400 hover:underline block">
                            {office.email}
                          </a>
          ...
          <div className="container-safe mx-auto max-w-4xl">
            ...
            <div className="space-y-4">
              {FAQ_PREVIEW.map((faq, index) => (
                <div key={index} className="p-6 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl">
          ...
          <div className="container-safe mx-auto max-w-7xl text-center">
            ...
            <div className="flex justify-center gap-4">
              <a
                ...
                className="p-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/30 hover:text-blue-600 dark:hover:text-blue-400 transition-all group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-pink-50 dark:hover:bg-pink-950/30 hover:text-pink-600 dark:hover:text-pink-400 transition-all group"
              >
